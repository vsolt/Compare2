...
def get_stat_repeated(dict):
    ''' Обчислює число повторних записі у  словнику індексів
    dict : словник індексів виду {'1214209780': [0], '1096907446': [1, 4], ... }
    Обчислює і повертає число додаткових індексів у значененях словника.
    '''
    res = 0
